...
// note : the id is obtained after a post, it's a random string generated by DataFair's API
...
export async function patchDocument (dataUrl, ligneId, payload, folder) {
  ...
  if (!folder) {
    if (file !== '') {
      ...
      formData.append('version', version || data.version)
      formData.append('taille', file.size)
  ...
  console.log(histoFichier.value)
  console.log(histoModif.value)
